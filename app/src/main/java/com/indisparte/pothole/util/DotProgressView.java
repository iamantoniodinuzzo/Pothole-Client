...
/**
 * Animation for dots simulating loading
...
public class DotProgressView extends View {
    ...
    private void applyAttrs(Context context, AttributeSet attrs) {
        ...
        try {
            mDotColor = a.getColor(R.styleable.DotProgressView_color, mDotColor);
            mDotCount = a.getInteger(R.styleable.DotProgressView_count, mDotCount);
            mDotCount = Math.min(Math.max(mDotCount, MIN_COUNT), MAX_COUNT);
            mTimeout = a.getInteger(R.styleable.DotProgressView_timeout, mTimeout);
    ...
    //method to draw customized dot on the canvas
    @Override
